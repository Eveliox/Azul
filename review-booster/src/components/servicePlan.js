...
export const SERVICES = [
  { id: 'website', name: 'Website', icon: 'globe', color: 'blue', category: 'Your digital foundation', description: 'Launch, maintain, and improve your business website.', status: 'Manual checklist', action: 'Open website plan' },
  { id: 'calls', name: 'Voice agents', icon: 'phone', color: 'green', category: 'Never miss the conversation', description: 'Plan your bilingual receptionist and its call handoff.', status: 'Vapi not connected', action: 'Open voice agent plan' },
