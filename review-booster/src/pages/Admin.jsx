...
const NAV = [['overview', 'Dashboard', 'grid'], ['website', 'Website', 'globe'], ['calls', 'Voice agents', 'phone'], ['reviews', 'Reviews', 'star'], ['seo', 'Local SEO', 'pin'], ['access', 'Workspace access', 'key']]
...
const TITLES = {
  ...
  calls: ['Voice agent workspace', 'Plan a better first conversation with your customers.'],
  ...
  return <div className="dashboard-shell">
    ...
    <div className="dashboard-body">
      ...
      <main className="dashboard-main">
        ...
        <footer className="dashboard-footer"><span>Azul Business Workspace</span><span>Websites · Voice agents · Reviews · Local SEO</span></footer>
      </main>
    </div>
