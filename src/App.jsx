...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 bg-gray-900/95 backdrop-blur-xl border-b border-gray-800 shadow-sm">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-5 flex items-center justify-between">
          <a href="#" className="flex items-center group" onClick={() => setIsMobileMenuOpen(false)}>
            <div className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-500 group-hover:text-blue-400 transition-colors duration-300">
              Azul.
            </div>
          </a>
          {/* Desktop Navigation */}
      ...
      {/* Hero Section */}
      <section className={`relative py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12 overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900`}>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-lg sm:text-xl md:text-2xl text-gray-400 leading-relaxed max-w-2xl font-light">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 sm:pt-4">
                <button className="group px-6 sm:px-8 md:px-10 py-4 sm:py-5 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base text-white hover:shadow-2xl hover:shadow-blue-500/40 transition-all duration-300 transform hover:scale-105 relative overflow-hidden">
                  <span className="relative z-10">Book a Free Consultation</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-700 to-blue-800 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </button>
                <a 
                  href="#portfolio" 
                  className="px-6 sm:px-8 md:px-10 py-4 sm:py-5 border-2 border-gray-700 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base hover:border-blue-500 hover:bg-blue-500/10 transition-all duration-300 text-center flex items-center justify-center group text-gray-300"
                >
      ...
      {/* About Section */}
      <section id="about" className={`py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12 bg-gray-900`}>
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-4 sm:mb-6 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 bg-clip-text text-transparent">
            About Azul
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 max-w-6xl mx-auto mb-12 sm:mb-16 md:mb-20">
          <div className="bg-gray-800 border-2 border-gray-700 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 shadow-xl">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h3 className="text-3xl sm:text-4xl md:text-5xl font-black mb-3 sm:mb-4 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 bg-clip-text text-transparent">
            Meet the Team
          </h3>
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
          {/* Evelio Gonzalez */}
          <div className="bg-gray-800 border-2 border-gray-700 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-xl hover:border-blue-500/50 transition-all duration-300 group">
            <div className="flex flex-col items-center text-center">
              <div className="relative mb-4 sm:mb-6">
                <img 
                  src="/evelio.jpg" 
                  alt="Evelio Gonzalez" 
                  className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full object-cover border-4 border-gray-700 group-hover:border-blue-500 transition-all duration-300 shadow-xl"
                />
              </div>
              <h4 className="text-xl sm:text-2xl font-bold mb-2 text-gray-100">Evelio Gonzalez</h4>
              <p className="text-blue-400 mb-3 sm:mb-4 font-medium text-sm sm:text-base">Co-Founder & Lead Developer</p>
        ...
        <div className="mt-12 sm:mt-16 md:mt-20 max-w-6xl mx-auto px-4">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 border-2 border-gray-700 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-2xl">
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 text-center text-gray-100">What Sets Us Apart</h3>
      ...
      {/* What We Do */}
      <section className={`py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12 bg-gray-900`}>
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-4 sm:mb-6 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 bg-clip-text text-transparent">
            What We Do
          </h2>
      ...
      <section id="portfolio" className={`py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12 relative bg-gray-800`}>
      ...
      {/* Pricing Section */}
      <section id="pricing" className={`py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12 bg-gray-900`}>
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-4 sm:mb-6 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 bg-clip-text text-transparent">
            Pricing
          </h2>
      ...
      {/* Contact Section */}
      <section id="contact" className={`py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12 bg-gray-800`}>
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-4 sm:mb-6 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 bg-clip-text text-transparent">
            Get In Touch
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
            ...
            >
              <div>
                ...
                <input 
                  ...
                  name="name"
                  required
                  className="w-full px-5 py-4 bg-gray-800 border-2 border-gray-700 rounded-xl text-gray-100 text-base focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
              ...
              <div>
                ...
                <textarea 
                  ...
                  rows="5"
                  required
                  className="w-full px-5 py-4 bg-gray-800 border-2 border-gray-700 rounded-xl text-gray-100 text-base focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all resize-none"
          ...
          <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/20 border-2 border-blue-500/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 shadow-xl flex flex-col items-center justify-center text-center">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 sm:px-8 md:px-10 py-4 sm:py-5 bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg sm:rounded-xl font-bold text-sm sm:text-base text-white hover:shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 transform hover:scale-105 inline-block"
            >
              Open Calendly
            </a>
          </div>
      ...
      {/* Footer */}
      <footer className="border-t border-gray-800 bg-gray-900 py-8 sm:py-12">
