    ...
    about: {
      ...
      cards: [
        {
          title: 'Our Mission',
          body:
            "To give South Florida's home service and local businesses the same growth technology that big national brands use — reviews, SEO, AI answering, and websites that actually book jobs — without the enterprise price tag or the language barrier.",
        },
        {
      ...
      whatWeDoCards: [
        ...
        },
        {
          ...
          body:
            "AI answering + missed-call text-back respond instantly, in the caller's language, even when your whole crew is out on a job.",
        },
        {
