      ...
      >
        ...
        <div className={`relative h-64 bg-gradient-to-br ${project.gradient} overflow-hidden`}>
          ...
          <div className="relative z-10 h-full flex flex-col justify-end p-8">
            {project.icon && <div className="text-6xl mb-4">{project.icon}</div>}
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-800/50">
            {project.liveUrl ? (
              <a
                ...
                className="flex-1 px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl font-semibold text-white hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 transform hover:scale-105 text-center"
              >
                Visit Live Site →
              </a>
            ) : (
